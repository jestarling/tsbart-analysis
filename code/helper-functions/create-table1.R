...
funbartCompare = function(filepath, filename, probit=FALSE, out.csv){
   ...
   data_set = c(rep('in-sample',nsim*2), rep('out-of-sample',nsim*2))
   model = c(rep('functional',nsim), rep('vanilla',nsim), rep('functional',nsim), rep('vanilla',nsim))
